import requests, threading, socket, ctypes, os, colorama
...
if ip in req_verify:
    try:
            def start():
                NameBanner = ("tik")
                req_banner = requests.get(f"http://artii.herokuapp.com/make?text={NameBanner}").text                                               
                print(req_banner)
                ...
                def check_sessionid():
                    ...
                    if '"status_code": 2091' in casesaesa:
                        ...
                        print(f"[{Fore.LIGHTGREEN_EX}-{Fore.RESET}] {Fore.LIGHTGREEN_EX}Successfully Login" + Fore.RESET)
                        time.sleep(2)
                        def set_nickname():
                            global nickname
                            ...
                            if '"status_code": 0' in req_set_nickname:
                                print(f"[{Fore.LIGHTGREEN_EX}-{Fore.RESET}] {Fore.LIGHTGREEN_EX}Successfully Set Nickname {Fore.RESET}To {Fore.LIGHTYELLOW_EX}kerrle" + Fore.RESET)
                                time.sleep(2)
                                ...
                                def set_bio():
                                    ...
                                    if '"status_code": 0' in response_change_bio:
                                        print(f"[{Fore.LIGHTGREEN_EX}-{Fore.RESET}] {Fore.LIGHTGREEN_EX}Successfully Set Bio {Fore.RESET}To {Fore.LIGHTYELLOW_EX}kerrle swap" + Fore.RESET)
                                            ...
                                            while True:
                                                ...
                                                if 'unique_id' in req:
                                                    if NoSpam == 0:
                                                        ...
                                                        os.system('cls')
                                                        print(req_banner)
                                                        print(f"[{Fore.LIGHTMAGENTA_EX}+{Fore.RESET}] All threads successfully initialized")
                                                        print(f"[{Fore.LIGHTMAGENTA_EX}+{Fore.RESET}] Swapped username {Fore.LIGHTGREEN_EX}@{username} {Fore.RESET}after{Fore.LIGHTGREEN_EX} {Attempt} {Fore.RESET}attempts")
                                                        input()
                                                        exit(0)
                        ...
                        if '"status_code": 2070' in req_check_sessionid:
                            ...
                            print(f"[-] Thread : {Thread}")
                            print(f"[{Fore.LIGHTGREEN_EX}-{Fore.RESET}] {Fore.LIGHTGREEN_EX}Successfully Login{Fore.RESET}")
                            print(f"[{Fore.LIGHTYELLOW_EX}-{Fore.RESET}] {Fore.LIGHTYELLOW_EX}You Can Change Username After 30 day{Fore.RESET}")
                            print(f"[{Fore.LIGHTRED_EX}-{Fore.RESET}] Press Enter To Exit {Fore.RESET}")
                            input()
                            exit(0)
                        else:
                            if '"status_code": 8' in req_check_sessionid:
                                ...
                                print(f"[-] Target : {username}")
                                print(f"[-] Thread : {Thread}")
                                print(f"[{Fore.LIGHTRED_EX}-{Fore.RESET}] {Fore.LIGHTYELLOW_EX}Failed Login {Fore.RESET}")
                                print(f"[{Fore.LIGHTRED_EX}-{Fore.RESET}] Press Enter To Exit {Fore.RESET}")
                                input()
                                exit(0)
                            else:
            ...
            def check_sessionid():
                ...
                if '"status_code": 2091' in req_check_sessionid:
                    ...
                    def set_nickname():
                        ...
                        req_set_nickname = requests.post(url_set_nickname, headers=headers_set_nickname, data=data_set_nickname, cookies=cookies_set_nickname).text
                        if '"status_code": 0' in req_set_nickname:
                            print(f"[{Fore.LIGHTGREEN_EX}-{Fore.RESET}] {Fore.LIGHTGREEN_EX}Successfully Set Nickname {Fore.RESET}To {Fore.LIGHTYELLOW_EX}{nickname}" + Fore.RESET)
                            time.sleep(2)
                            ...
                            def set_bio():
                                ...
                                response_change_bio = requests.post(url_change_bio, data=data_change_bio, cookies=cookies_change_bio, headers=headers_change_bio).text
                                if '"status_code": 0' in response_change_bio:
                                    print(f"[{Fore.LIGHTGREEN_EX}-{Fore.RESET}] {Fore.LIGHTGREEN_EX}Successfully Set Bio {Fore.RESET}To {Fore.LIGHTYELLOW_EX}{Bio}" + Fore.RESET)
                    ...
                    if '"status_code": 2070' in req_check_sessionid:
                        ...
                        print(f"[{Fore.LIGHTGREEN_EX}-{Fore.RESET}] {Fore.LIGHTGREEN_EX}Successfully Login{Fore.RESET}")
                        print(f"[{Fore.LIGHTYELLOW_EX}-{Fore.RESET}] {Fore.LIGHTYELLOW_EX}You Can Change Username After 30 day{Fore.RESET}")
                        print(f"[{Fore.LIGHTYELLOW_EX}-{Fore.RESET}] Press Enter To Exit{Fore.RESET}")
                        input()
                        exit(0)
                    else:
                        if '"status_code": 8' in req_check_sessionid:
                            ...
                            print(f"[-] Target : {username}")
                            print(f"[-] Thread : {Thread}")
                            print(f"[{Fore.LIGHTYELLOW_EX}-{Fore.RESET}] {Fore.LIGHTYELLOW_EX}Failed Login {Fore.RESET}")
                            print(f"[{Fore.LIGHTYELLOW_EX}-{Fore.RESET}] Press Enter To Exit {Fore.RESET}")
                            input()
                            exit(0)
                        else:
